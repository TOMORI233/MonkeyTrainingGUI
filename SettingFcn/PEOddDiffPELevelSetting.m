function varargout = PEOddDiffPELevelSetting(varargin)
% PEODDDIFFPELEVELSETTING MATLAB code for PEOddDiffPELevelSetting.fig
%      PEODDDIFFPELEVELSETTING, by itself, creates a new PEODDDIFFPELEVELSETTING or raises the existing
%      singleton*.
%
%      H = PEODDDIFFPELEVELSETTING returns the handle to a new PEODDDIFFPELEVELSETTING or the handle to
%      the existing singleton*.
%
%      PEODDDIFFPELEVELSETTING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PEODDDIFFPELEVELSETTING.M with the given input arguments.
%
%      PEODDDIFFPELEVELSETTING('Property','Value',...) creates a new PEODDDIFFPELEVELSETTING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PEOddDiffPELevelSetting_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PEOddDiffPELevelSetting_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PEOddDiffPELevelSetting

% Last Modified by GUIDE v2.5 14-Sep-2022 21:42:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PEOddDiffPELevelSetting_OpeningFcn, ...
                   'gui_OutputFcn',  @PEOddDiffPELevelSetting_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PEOddDiffPELevelSetting is made visible.
function PEOddDiffPELevelSetting_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PEOddDiffPELevelSetting (see VARARGIN)
...
% Choose default command line output for PEOddDiffPELevelSetting
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PEOddDiffPELevelSetting wait for user response (see UIRESUME)
uiwait(handles.PEOddDiffPELevelSettingFig);


% --- Outputs from this function are returned to the command line.
function varargout = PEOddDiffPELevelSetting_OutputFcn(hObject, eventdata, handles) 
