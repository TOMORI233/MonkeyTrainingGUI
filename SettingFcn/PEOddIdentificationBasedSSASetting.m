function varargout = PEOddIdentificationBasedSSASetting(varargin)
% PEOddIdentificationBasedSSASetting MATLAB code for PEOddIdentificationBasedSSASetting.fig
%      PEOddIdentificationBasedSSASetting, by itself, creates a new PEOddIdentificationBasedSSASetting or raises the existing
%      singleton*.
%
%      H = PEOddIdentificationBasedSSASetting returns the handle to a new PEOddIdentificationBasedSSASetting or the handle to
%      the existing singleton*.
%
%      PEOddIdentificationBasedSSASetting('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PEOddIdentificationBasedSSASetting.M with the given input arguments.
%
%      PEOddIdentificationBasedSSASetting('Property','Value',...) creates a new PEOddIdentificationBasedSSASetting or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PEOddIdentificationBasedSSASetting_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PEOddIdentificationBasedSSASetting_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PEOddIdentificationBasedSSASetting

% Last Modified by GUIDE v2.5 16-Dec-2022 20:43:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PEOddIdentificationBasedSSASetting_OpeningFcn, ...
                   'gui_OutputFcn',  @PEOddIdentificationBasedSSASetting_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PEOddIdentificationBasedSSASetting is made visible.
function PEOddIdentificationBasedSSASetting_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PEOddIdentificationBasedSSASetting (see VARARGIN)
...
% Choose default command line output for PEOddIdentificationBasedSSASetting
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PEOddIdentificationBasedSSASetting wait for user response (see UIRESUME)
uiwait(handles.ClickTrainOddSettingFig);


% --- Outputs from this function are returned to the command line.
function varargout = PEOddIdentificationBasedSSASetting_OutputFcn(hObject, eventdata, handles) 
